...
- Katkılar birçok yolla yapılabilir ve Github'a bağlı değildir. Projeyi çevrenize duyurarak da katkıda bulunabilirsiniz. Ayrıca, çözdüğünüz bir sorunla karşılaşabilecek diğer insanlara yardım ederek [Discord Topluluğumuza](https://discord.gg/bYWVWrDkCU) da katkıda bulunabilirsiniz.
- E-posta ile iletişim için <ziarparvaiz@gmail.com>.
- GitHub [Tartışmaları](https://github.com/Fire-Oceann/CS-Space/discussions)
- Twitter [ziarparvaiz](https://twitter.com/ziarparvaiz)
...
- Geçici çözümler önererek veya düzelterek [açık konuları](https://github.com/Fire-Oceann/CS-Space/issues?q=is%3Aopen+is%3Aissue) çözmemize yardımcı olun.
...
- [Başkaları tarafından talep edilen özelliklere](https://github.com/Fire-Oceann/CS-Space/issues?q=is%3Aissue+is%3Aopen+label%3A%22%F0%9F%9A%80+feature%22) bir göz atın ve üzerinde çalışmak istediğiniz bir şey görürseniz bir PR atmayı düşünün.
...
Yalnızca bir hatayı düzeltiyorsanız hemen bir Pull Request göndermeyin. Bir hata bulduysanız onu [issue raporu](https://github.com/Fire-Oceann/CS-Space/issues/new/choose) olarak bize bildirmeniz gerek. Bu, sorunu bizzat takip ederek düzeltmek isteyeceğimiz durumlarda daha yararlı olacaktır.

### 📕 Yeni Sorunları Bildirme

Yeni [bir issue açarken](https://github.com/Fire-Oceann/CS-Space/issues/new/choose) her zaman issue şablonunu doldurduğunuzdan emin olun. Bu adım çok önemli! Bunu yapmamak, sorununuzun zamanında yönetilememesiyle sonuçlanabilir. Böyle bir durumda bunu kişisel algılamayın ve şablonun gerektirdiği tüm bilgileri girdikten sonra yeni bir konu açmaktan çekinmeyin.
...
> Biz [`PULL REQUEST TEMPLATE`](https://github.com/Fire-Oceann/CS-Space/blob/develop/.github/PULL_REQUEST_TEMPLATE.md) kullanıyoruz. Lütfen bir pull request gönderirken aşağıdakilerin yapıldığından emin olun:
...
CS-Space'a katkıda bulunarak, katkılarınızın [Lisans Dosyası](https://github.com/Fire-Oceann/CS-Space/blob/develop/LICENSE) kapsamında lisanslanacağını kabul etmiş olursunuz.
